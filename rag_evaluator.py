...
try:
    from sistema_rag.search.conversational_rag import ModularConversationalRAG as MultimodalRagSearcher
except ImportError:
    print("ERRO: O sistema RAG modular não foi encontrado.")
    print("Por favor, certifique-se de que o sistema_rag está instalado corretamente.")
    exit()
...
class RAGEvaluator:
    ...
    def create_test_dataset(self) -> List[TestQuestion]:
        """
        Cria dataset de teste a partir das variáveis de ambiente
        """
        # Carrega perguntas das variáveis de ambiente
